...
|----|----------|-------------------|-----------|
| A-001 | Os tempos medidos neste Mac valem na VPS | Lá a memória é menor; a primeira execução **fria** de área grande custou 3,9 s aqui contra 640 ms quente. Pode obrigar a baixar o teto | [x] **Falsa no pior caso**, medida em 2026-09-13: rota completa sobre São Paulo excedeu 90 s; Censo isolado, 3,606 s. Buffers reais ficaram em 188–892 ms |
...
| A-005 | A interseção do zoneamento por área tem custo comparável ao do Censo | Se os 61.784 polígonos pesarem sob área grande, o bloco ganha teto próprio | [x] **Falsa**, medida em 2026-09-13: zoneamento de São Paulo excedeu 15 s; é o gargalo da rota |
