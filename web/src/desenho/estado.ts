...
export function criarEstadoDesenho(
  ...
  const problema = validar(modo, coordenadas);
 ...
 *
 * No modo ponto o novo clique SUBSTITUI o anterior, em vez de acumular: um ponto tem
 * um lugar só, e quem clicou no lugar errado está corrigindo, não desenhando.
 */
